    ...
    <div className="flex flex-wrap justify-center gap-8 md:px-[14rem] mb-10">
      {countriesFacts.map(
        ({ name, capital, population, area, fact, image }) => {
          ...
          return (
            <div
              className="text-white text-sm w-[21rem] px-4 py-8 bg-[#585f72] rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-600 hover:border-gray-400 hover:scale-105 transition-all duration-300 ease-linear cursor-pointer"           >
